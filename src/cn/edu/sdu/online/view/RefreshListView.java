...
public class RefreshListView extends ListView implements OnScrollListener {
	...
	private void initFooter() {
		...
		footerView = LayoutInflater.from(getContext()).inflate(
				R.layout.activity_listview_refresh_footer, null);

		loading_img_footer = (ImageView) footerView
				.findViewById(R.id.pb_listview_footer_progress);
	...
	private void initHeader() {
		...
		loading_img_header = (ImageView) headerView
	...
	private void initAnimation() {
		...
		// 刷新数据时load动画
		loadAnim = new RotateAnimation(0, 359, Animation.RELATIVE_TO_SELF,
				0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
...
//		refreshHeaderViewState();
		...
		tvState.setText("正在获取新内容");
		 if (mOnRefreshListener != null) {//执行刷新
	...
	/**
	 * 刷新头布局的状态 当ListView滚动状态改变时回调 SCROLL_STATE_IDLE // 当ListView滚动停止时
