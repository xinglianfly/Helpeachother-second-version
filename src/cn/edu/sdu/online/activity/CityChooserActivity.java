...
import cn.edu.sdu.online.adapter.CityAdapter;
import cn.edu.sdu.online.view.MySideBar;
...
public class CityChooserActivity extends Activity implements
		cn.edu.sdu.online.view.MySideBar.OnTouchingLetterChangedListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		CityAdapter adapter = new CityAdapter(this, data, letterCharList, title);
